      ...
      devShells = forAllSystems (system:
        let
          ...
          fontsConf = pkgs.writeText "nd-headless-fonts.conf" ''
            ...
            <fontconfig>
              <dir>${pkgs.cantarell-fonts}/share/fonts</dir>
              ...
              <alias><family>sans-serif</family><prefer>
                <family>Cantarell</family><family>DejaVu Sans</family>
              </prefer></alias>
        ...
        in
        {
          default = pkgs.mkShell {
            packages = with pkgs; [
              ...
              cantarell-fonts  # the GNOME UI font: headless captures should look like a real session
              dejavu_fonts     # broad fallback for anything Cantarell lacks
