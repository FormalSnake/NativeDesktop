...
an ubuntu:24.04 container, so the floor is glibc 2.39, GTK 4.14, and
libadwaita 1.5. Static linking is not an option for this stack: libadwaita
...
| `libadwaita-1.so.0` (>= 1.5) | `libadwaita-1-0` | `libadwaita` |
