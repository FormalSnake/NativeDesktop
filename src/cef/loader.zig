...
pub const Api = struct {
    ...
    string_list_alloc: *const fn () callconv(.c) c.cef_string_list_t,
    string_list_append: *const fn (list: c.cef_string_list_t, value: [*c]const c.cef_string_t) callconv(.c) void,
    string_list_free: *const fn (list: c.cef_string_list_t) callconv(.c) void,
    ...
    request_context_get_global_context: *const fn () callconv(.c) [*c]c.cef_request_context_t,
    value_create: *const fn () callconv(.c) [*c]c.cef_value_t,
...
fn lookupAll(l: *std.DynLib) ?Api {
    return .{
        ...
        .string_list_alloc = l.lookup(@FieldType(Api, "string_list_alloc"), "cef_string_list_alloc") orelse return null,
        .string_list_append = l.lookup(@FieldType(Api, "string_list_append"), "cef_string_list_append") orelse return null,
        .string_list_free = l.lookup(@FieldType(Api, "string_list_free"), "cef_string_list_free") orelse return null,
        ...
        .request_context_get_global_context = l.lookup(@FieldType(Api, "request_context_get_global_context"), "cef_request_context_get_global_context") orelse return null,
        .value_create = l.lookup(@FieldType(Api, "value_create"), "cef_value_create") orelse return null,
