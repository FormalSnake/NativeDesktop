			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Display & Navigation', slug: 'components/display-navigation' },
						{ label: 'Composition Components', slug: 'components/composition-components' },
						...
						{ label: 'Progress & Loading', slug: 'components/progress-loading' },
						...
						{ label: 'Overlays', slug: 'components/overlays' },
						{ label: 'Rich Text', slug: 'components/rich-text' },
						{ label: 'Drag and Drop', slug: 'components/drag-and-drop' },
						{ label: 'Code Editor', slug: 'components/code-editor' },
					],
				},
				{
