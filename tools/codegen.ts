...
const STRUCTURAL: Record<string, StructuralTemplate> = {
  ...
  Menubar: {
    append: () => "        ndMenubarAttachMenu(parent, child, null);\n",
    insertBefore: () => "        ndMenubarAttachMenu(parent, child, b);\n",
    remove: () => "        ndMenubarRemoveMenu(parent, child);\n",
  },
  Menu: {
    append: () => "        ndMenuAttachItem(parent, child, null);\n",
    insertBefore: () => "        ndMenuAttachItem(parent, child, b);\n",
    remove: () => "        ndMenuRemoveItem(parent, child);\n",
  },
  ...
  MenuButton: {
    append: () => "        ndMenuOwnerAttach(parent, child, null);\n",
    insertBefore: () => "        ndMenuOwnerAttach(parent, child, b);\n",
...
const SWIFT_STRUCTURAL: Record<string, SwiftStructuralTemplate> = {
  ...
  MenuButton: {
    append: () => "        ndMenuOwnerAttach(parent, child, before: nil)\n",
    insertBefore: () => "        ndMenuOwnerAttach(parent, child, before: before)\n",
    remove: () => "        ndMenuOwnerRemove(parent, child)\n",
  },
  SplitButton: {
    append: () => "        ndMenuOwnerAttach(parent, child, before: nil)\n",
